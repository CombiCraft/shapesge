...
/**
 * Obdĺžník ktorý sa zobrazí v okne hry (na plátne).
 *
...
public class Obdlznik {
    ...
    /**
     * Vytvorí nový Obdĺžnik na predvolenej pozícii s predvolenými parametrami.
     * <p>
     *     Predvolené parametre:
     *     <ul>
     *         <li>Šírka: 30 pixelov</li>
     *         <li>Výška: 60 pixelov</li>
     ...
     *     </ul>
     *     <p>
     *          Pozíciu, priemer a farbu môžeš zmeniť pomocou metód {@link Obdlznik#zmenPoziciu(int x, int y)},
     *          {@link Obdlznik#zmenVelkost(int novaSirka, int novaVyska)} a {@link Obdlznik#zmenFarbu}.
     *     </p>
     * </p>
     */
    @SuppressWarnings("unused")
    ...
    /**
     * Vytvorí nový Obdĺžnik na danej pozícii s predvolenými parametrami.
     * <p>
     *     Predvolené parametre:
     *     <ul>
     *         <li>Šírka: 30 pixelov</li>
